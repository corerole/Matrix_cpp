...
export namespace matrix {
	...
	using const_diag_iter = matrix_const_diagonal_iterator<detail::tCont>;
	static_assert(std::random_access_iterator<const_diag_iter>);
	static_assert(std::totally_ordered<const_diag_iter>);
	...
	struct const_Submatrix { // : std::ranges::view_interface<const_Submatrix<Cont>>{
		...
		public:
			...
			constexpr size_type get_elem_col_index(const_reference elem) const noexcept {
				auto&& [_, col_index] = get_indices(elem);
				return col_index;
			}

			constexpr size_type get_elem_row_index(const_reference elem) const noexcept {
				auto&& [row_index, _] = get_indices(elem);
				return row_index;
			}
	...
	struct Submatrix : public const_Submatrix<Cont> {
		...
		public:
			void set_submatrix(const_reference fst, const auto& mtx) {
				auto& cnt = *cont;
				cnt.set_submatrix(fst, mtx);
			}
		...
		public:
			...
			constexpr const_col_iterator col_cbegin() const noexcept { return const_col_iterator(col_begin()); }
			constexpr const_col_iterator col_cend() const noexcept { return const_col_iterator(col_end()); }
			constexpr col_reverse_iterator col_rbegin() noexcept { return col_reverse_iterator(col_end()); }
			constexpr col_reverse_iterator col_rend() noexcept { return col_reverse_iterator(col_begin()); }
			constexpr const_col_reverse_iterator col_crbegin() const noexcept { return const_col_reverse_iterator(col_cend()); }
			constexpr const_col_reverse_iterator col_crend() const noexcept { return const_col_reverse_iterator(col_cbegin()); }
			...
			constexpr const_diagonal_iterator diagonal_cbegin() const noexcept { return const_diagonal_iterator(diagonal_begin()); }
			constexpr const_diagonal_iterator diagonal_cend() const noexcept { return const_diagonal_iterator(diagonal_end()); }
			constexpr diagonal_reverse_iterator diagonal_rbegin() noexcept { return diagonal_reverse_iterator(diagonal_end()); }
			constexpr diagonal_reverse_iterator diagonal_rend() noexcept { return diagonal_reverse_iterator(diagonal_begin()); }
			constexpr const_diagonal_reverse_iterator diagonal_rbegin() const noexcept { return const_diagonal_reverse_iterator(diagonal_end()); }
			constexpr const_diagonal_reverse_iterator diagonal_rend() const noexcept { return const_diagonal_reverse_iterator(diagonal_begin()); }
			constexpr const_diagonal_reverse_iterator diagonal_crbegin() const noexcept { return const_diagonal_reverse_iterator(diagonal_cend()); }
			constexpr const_diagonal_reverse_iterator diagonal_crend() const noexcept { return const_diagonal_reverse_iterator(diagonal_cbegin()); }
